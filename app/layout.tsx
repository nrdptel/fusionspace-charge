...
// The 1200×630 social share card — a committed static asset, regenerated by
// scripts/gen-og.mjs. Resolved absolutely against metadataBase. Matches the Fusion
// Space landing card (brand mark over the name, tagline, domain, on the indigo glow).
