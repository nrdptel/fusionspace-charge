    ...
    <section className="mt-10">
      <details className="group rounded-md border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm dark:border-zinc-800 dark:bg-zinc-900/50">
        ...
        <div className="mt-3 space-y-3 text-zinc-600 dark:text-zinc-400">
          <p>
            Charge runs entirely in your browser. Once you&apos;ve opened it on a device
            with a connection, it keeps working with no signal — so you can size and log
            charges at the pad. Install it and it opens like any app, full-screen and
            offline.
          </p>
            ...
            <>
              ...
              <ul className="space-y-1.5">
                ...
                <li>
                  ...
                  the install icon in the address bar, or menu → Install Charge.
                </li>
              </ul>
            </>
          )}
          ...
          <p className="text-xs text-zinc-500 dark:text-zinc-400">
            Your saved rockets and ground-test log live on the device, so they&apos;re
            there offline too. Open it online now and again to pick up any updates.
          </p>
        </div>
      </details>
    </section>
